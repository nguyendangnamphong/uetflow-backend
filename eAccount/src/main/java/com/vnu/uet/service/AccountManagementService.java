...
public class AccountManagementService {
    ...
    public boolean checkIfDeletable(String targetEmail, String requesterEmail) {
        try {
            if (eRequestClient.isUserAssociatedWithActiveRequests(targetEmail)) {
                return false;
            }
