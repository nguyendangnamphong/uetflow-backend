...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0ccfded4-e274-4a84-83e5-3f48778f3204' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c383696a-0313-4f8e-973e-6408802d6e78');
      cy.get(`[data-cy="name"]`).should('have.value', 'c383696a-0313-4f8e-973e-6408802d6e78');
